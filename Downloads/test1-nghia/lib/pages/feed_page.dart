...
class _FeedPageState extends State<FeedPage> {
  ...
  Future<String> _getProfileName(String uid) async {
  ...
  Future<void> _submitPost() async {
    ...
    final profileName = await _getProfileName(user.uid);
  ...
  Future<void> _showCommentsDialog(DocumentSnapshot postDoc) async {
    ...
    final postOwnerId = (postDoc.data() as Map<String, dynamic>)['uid'] ?? '';
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            // Gửi thông báo nếu không phải chủ bài viết
