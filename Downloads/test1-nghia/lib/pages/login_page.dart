...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _handleForgotPassword() async {
    ...
    try {
      ...
      setState(() => _errorMessage = 'Không thể gửi email khôi phục:  [36m${e.toString()} [39m');
    }
  }

  // Hàm gửi email khôi phục mật khẩu với ActionCodeSettings
  Future<void> sendResetEmail(String email) async {
    final settings = ActionCodeSettings(
      url: 'https://newappfashion-da9d3.web.app/reset-password',
  ...
  // Hiện dialog quên mật khẩu
  Future<void> _handleForgotPasswordDialog() async {
